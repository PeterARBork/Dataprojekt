...
We take the collision frequency to be some $\lambda$ - the literature suggests formulas for gasses and for diluted solutions. The time between two collisions will then be exponentially distributed,
\begin{align}
...
\section{The particle's trajectory}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{results/Gillespiewalk.png}
    \caption{Hard sphere random walk}
